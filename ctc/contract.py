...
METERING_LOCATION: dict[str, str] = {
    ...
    # The VS Code extension chats via the Responses API too. Field nesting is the
    # same copilot_usage.total_nano_aiu; exact carrier (json vs sse) to confirm via
    # the operator acceptance (Task 5). The extractor is event-name-agnostic.
